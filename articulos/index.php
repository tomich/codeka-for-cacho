...
<html>
	<head>
		...
		function validarArticulo(busq){
			var codigo=document.getElementById("codbarras").value;
			miPopup = window.open("comprobararticulo.php?codbarras="+codigo+"&busq="+busq,"frame_datos","width=700,height=80,scrollbars=yes");
		}	
		
		function prebusqueda() {
		if (document.getElementById("codbarras").value==""){
		buscar()
		} else if (document.getElementById("codbarras").value!=""){
		validarArticulo("si")
		}
		}
		</script>
		...
		<div id="pagina">
			<div id="zonaContenido">
				...
				<form id="form_busqueda" name="form_busqueda" method="post" action="rejilla.php" target="frame_rejilla">
					...
					<div id="botonBusqueda"><img src="../img/botonbuscar.jpg" width="69" height="22" border="1" onClick="prebusqueda()" onMouseOver="style.cursor=cursor">
